...
class Implant:
	...
	var zippy_fingers: bool = false
	var he_grenade: bool = false
	var camo: float = 0
	var kick_improvement = false
	var hidden: bool = false
	var exploisoncore: bool = false
	var fieldkit: bool = false
	var flechette_grenade: bool = false
	var sleep_grenade: bool = false
	var pills_consumable:bool = false
	var noir_vision: bool = false
...
func _ready():
	...
	new_implant = Implant.new()
	new_implant.i_name = "Speedrunner Organ Package"
	new_implant.explanation = "Luminous essence of speed and reaction."
	new_implant.hidden = true
	new_implant.price = 0
	new_implant.speed_bonus = 6
	new_implant.speedrun = true
	new_implant.legs = true
	new_implant.texture = load("res://Textures/Menu/Implants/speed4.png")
	...
	new_implant = Implant.new()
	new_implant.i_name = "Extracted explosive core"
	new_implant.explanation = "An explosive core extracted from some mech. Can be used in advanced demolition techniques."
	new_implant.hidden = true
	new_implant.price = 0
	new_implant.speed_bonus = 0
	new_implant.arms = true
	new_implant.exploisoncore = true
	new_implant.texture = load("res://Textures/Menu/Implants/exploisoncore.png")
	
	IMPLANTS.append(new_implant)
	
	new_implant = Implant.new()
	new_implant.i_name = "Pocket Of Portable Pills"
	new_implant.explanation = "Some crap from the black market. It's better not to use this."
	new_implant.price = 5000
	new_implant.speed_bonus = 0
	new_implant.arms = true
	new_implant.pills_consumable = true
	new_implant.texture = load("res://Textures/Menu/Implants/pills_consumable.png")
	...
	new_implant.texture = load("res://Textures/Items/medkit1.png")
	...
	new_implant = Implant.new()
	new_implant.i_name = "Augmented arm"
	new_implant.explanation = "Allows you to carry 3 weapons. Suitable for those who like a large arsenal."
	new_implant.price = 1000
	new_implant.augarm = true
	new_implant.speed_bonus = 0
	new_implant.arms = true
	...
	new_implant = Implant.new()
	new_implant.i_name = "Zippy Fingers"
	new_implant.explanation = "A special implant with which the weapon does not require ammunition, but works like Zippy. Only for the luckiest (and tenacious)."
	new_implant.price = 0
	new_implant.hidden = true
	new_implant.speed_bonus = 0
	new_implant.zippy_fingers = true
	new_implant.arms = true
	new_implant.texture = load("res://Textures/Menu/Implants/zippy_fingers.png")
	...
	new_implant = Implant.new()
	new_implant.i_name = "Pills Filter"
	new_implant.explanation = "One of the failed projects of the Pharmaceutical Department. No idea what it does."
	new_implant.price = 0
	new_implant.hidden = true
	new_implant.speed_bonus = 0
	new_implant.head = true
	new_implant.pills_filter = true
	new_implant.texture = load("res://Textures/Menu/Implants/pills_filter.png")
	...
	new_implant = Implant.new()
	new_implant.i_name = "Tactic Vision Ver.3"
	new_implant.explanation = "Strange glasses, popular among tacticians and noir fans."
	new_implant.speed_bonus = 0
